...
public class TeamBuildEndpoint implements UnprotectedRootAction {
    ...
    public void doBuild(
        ...
        logger.log(Level.FINE, String.format("111111111111111In Build propsMap has'%d' size.", map.size()));
    ...
    public void doBuildWithParameters(
        ...
        logger.log(Level.FINE, String.format("111111111111111In Build with parameters propsMap has'%d' size.", map.size()));
