...
public class TeamPullRequestMergedDetailsAction implements Action, Serializable {
    ...
    public TeamPullRequestMergedDetailsAction(final GitPullRequestEx gitPullRequest, final String message, final String
     detailedMessage, final String collectionUri, final String sourceBranch) {
